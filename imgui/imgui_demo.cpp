...
void ImGui::ShowTestWindow(bool* p_open)
{
    ...
    if (ImGui::CollapsingHeader("Columns"))
    {
        ...
        */
        ...
        // Create multiple items in a same cellState before switching to next column
        ...
        bool node_open = ImGui::TreeNode("Tree within single cellState");
        ImGui::SameLine(); ShowHelpMarker("NB: Tree node must be poped before ending the cellState.\nThere's no storage of state per-cellState.");
        if (node_open)
        {
